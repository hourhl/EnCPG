name := "joern-trace-extension-schema-extender"
...
replaceDomainClassesInJoern := {
  ...
  val targetFile = joernInstallPath.value / "lib" / s"io.shiftleft.codepropertygraph-domain-classes_${scalaBin}-${Versions.cpg}.jar"
